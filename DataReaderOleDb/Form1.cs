    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            string cn = "Provider = Microsoft.Jet.OLEDB.4.0; " +
                "Data Source=C:\\Program Files/Microsoft SQL Server/MSSQL12.MSSQLSERVER/MSSQL/DATA/friend.mdb";   // 資料庫連接字串

            OleDbConnection db = new OleDbConnection(cn);
            db.Open();   //使用Open方法開啟和資料庫的連接
            OleDbCommand cmd = new OleDbCommand("SELECT * FROM 通訊錄", db);
